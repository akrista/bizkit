...
/**
* @see \App\Http\Controllers\Svelte\TeamController::updateMember
...
/**
* @see \App\Http\Controllers\Svelte\TeamController::removeMember
...
/**
* @see \App\Http\Controllers\Svelte\TeamController::invite
 * @see app/Http/Controllers/Svelte/TeamController.php:194
 * @param team - Default: '$currentTeam'
 * @route '/svelte/settings/teams/{team?}/invitations'
 */
...
invite.definition = {
    methods: ["post"],
    url: '/svelte/settings/teams/{team?}/invitations',
} satisfies RouteDefinition<["post"]>
...
/**
* @see \App\Http\Controllers\Svelte\TeamController::cancelInvitation
 * @see app/Http/Controllers/Svelte/TeamController.php:221
 * @param team - Default: '$currentTeam'
 * @route '/svelte/settings/teams/{team?}/invitations/{code}'
 */
...
cancelInvitation.definition = {
    methods: ["delete"],
    url: '/svelte/settings/teams/{team?}/invitations/{code}',
} satisfies RouteDefinition<["delete"]>
...
/**
* @see \App\Http\Controllers\Svelte\TeamController::acceptInvitation
 * @see app/Http/Controllers/Svelte/TeamController.php:235
 * @route '/svelte/invitations/{invitation}/accept'
 */
...
acceptInvitation.definition = {
    methods: ["get","head"],
    url: '/svelte/invitations/{invitation}/accept',
} satisfies RouteDefinition<["get","head"]>
...
const TeamController = { index, store, edit, update, destroy, updateMember, removeMember, invite, cancelInvitation, acceptInvitation }
