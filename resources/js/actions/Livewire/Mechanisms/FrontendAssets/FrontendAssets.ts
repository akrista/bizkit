 ...
 * @route '/livewire-fcc006fa/livewire.min.js'
 */
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-fcc006fa/livewire.min.js',
 ...
 * @route '/livewire-fcc006fa/livewire.min.js.map'
 */
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-fcc006fa/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/livewire-fcc006fa/livewire.csp.min.js.map'
 */
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-fcc006fa/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
