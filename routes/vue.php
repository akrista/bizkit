...
use App\Http\Controllers\Vue\ProfileController;
use App\Http\Controllers\Vue\SecurityController;
use App\Http\Controllers\Vue\TeamController;
use App\Http\Middleware\EnsureTeamMembership;
use Illuminate\Support\Facades\Route;
use Inertia\Inertia;
use Laravel\Fortify\Features;

Route::prefix('vue')->name('vue.')->group(function (): void {
