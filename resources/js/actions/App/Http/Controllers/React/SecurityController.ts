...
/**
* @see \App\Http\Controllers\React\SecurityController::edit
 * @see app/Http/Controllers/React/SecurityController.php:23
 * @route '/react/settings/security'
 */
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\React\SecurityController::updatePassword
...
/**
* @see \App\Http\Controllers\React\SecurityController::disableTwoFactor
 * @see app/Http/Controllers/React/SecurityController.php:102
 * @route '/react/settings/two-factor/disable'
 */
...
disableTwoFactor.definition = {
    methods: ["post"],
    url: '/react/settings/two-factor/disable',
