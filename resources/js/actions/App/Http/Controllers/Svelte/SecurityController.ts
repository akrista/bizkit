...
/**
* @see \App\Http\Controllers\Svelte\SecurityController::edit
 * @see app/Http/Controllers/Svelte/SecurityController.php:23
 * @route '/svelte/settings/security'
 */
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\Svelte\SecurityController::updatePassword
...
/**
* @see \App\Http\Controllers\Svelte\SecurityController::disableTwoFactor
 * @see app/Http/Controllers/Svelte/SecurityController.php:102
 * @route '/svelte/settings/two-factor/disable'
 */
...
disableTwoFactor.definition = {
    methods: ["post"],
    url: '/svelte/settings/two-factor/disable',
